...
def build_candidates(liked_ids: set[int], seen_ids: set[int], max_seed: int = 200, pages_per_seed: int = 1, popular_pages: int = 3):
    """
    Returns:
    ...
    cand = {}
    provenance = defaultdict(lambda: {"rec_hits": 0, "sim_hits": 0, "seed_ids": set()})
